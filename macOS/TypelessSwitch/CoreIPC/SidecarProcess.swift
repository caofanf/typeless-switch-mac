...
actor SidecarProcess: RPCTransportProtocol {
    ...
    private static let logger = Logger(subsystem: "com.typelessswitch.mac", category: "Sidecar")
    ...
    private func launchAndHandshake() async throws -> CoreHello {
        ...
        do {
            ...
            guard hello.protocolName == "typeless-switch-core", hello.protocolVersion == "1.0" else {
